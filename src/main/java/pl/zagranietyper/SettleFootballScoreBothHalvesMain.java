...
import pl.zagranietyper.parser.FootballScoreBothHalvesParser;
...
public final class SettleFootballScoreBothHalvesMain {
    ...
    private SettleFootballScoreBothHalvesMain() {
    }
    ...
    public static void main(
        ...
        FootballScoreBothHalvesParser parser =
        ...
        Map<FootballScoreBothHalvesParser.Status, Integer>
                parserStatuses =
                new EnumMap<>(
                        FootballScoreBothHalvesParser.Status.class
                );

        for (
                FootballScoreBothHalvesParser.Status status :
                FootballScoreBothHalvesParser.Status.values()
        ) {
            parserStatuses.put(
                    status,
                    0
        ...
        for (
            ...
            if (
                ...
                if (
                        parser.looksLikeScoreBothHalves(
                                candidate.tipTitle()
                        )
                ) {
            ...
            if (
                    result.market()
                            == FootballScoreBothHalvesParser.Market
    ...
    private static boolean parseApplyFlag(
        ...
        throw new IllegalArgumentException(
                "Usage: SettleFootballScoreBothHalvesMain [--apply]"
        );
    }
    ...
    private static boolean isSubjectIssue(
        ...
        return status
                == FootballScoreBothHalvesParser.Status.SUBJECT_NOT_FOUND
                || status
                == FootballScoreBothHalvesParser.Status.SUBJECT_MISMATCH
                || status
                == FootballScoreBothHalvesParser.Status.SUBJECT_AMBIGUOUS;
    }
    ...
    private static void printHeader(
        ...
        System.out.println(
                "Zagranie Typer — Football SCORE BOTH HALVES Settlement"
        );
    ...
    private static void printParsed(
        ...
        for (
            ...
            FootballScoreBothHalvesParser.ParseResult p =
                    row.parseResult();
    ...
    private static void printRejected(
        ...
        System.out.println(
                "SCORE-BOTH-HALVES-LIKE REJECTED="
                        + rejected.size()
        );
    ...
    private static void printDryRunFooter() {
        ...
        System.out.println(
                "  pl.zagranietyper.SettleFootballScoreBothHalvesMain --apply"
        );
    }
    ...
    private record Parsed(
            Candidate candidate,
            FootballScoreBothHalvesParser.ParseResult parseResult,
            SettlementDecision decision
    ) {
    }
