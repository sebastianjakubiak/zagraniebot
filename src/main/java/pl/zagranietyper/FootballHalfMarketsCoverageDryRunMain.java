...
public final class FootballHalfMarketsCoverageDryRunMain {
    ...
    record Row(long legId,long betId,String normalized,FootballScorePeriod period,UnifiedFootballMarket.Condition condition,SettlementDecision decision){}
}
