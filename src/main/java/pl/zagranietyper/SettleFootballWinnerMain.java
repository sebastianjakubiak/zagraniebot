...
import pl.zagranietyper.parser.FootballWinnerParser;
...
public final class SettleFootballWinnerMain {
    ...
    private SettleFootballWinnerMain() {
    }
    ...
    public static void main(
        ...
        Map<FootballWinnerParser.Status, Integer>
                parserStatuses =
                new EnumMap<>(
                        FootballWinnerParser.Status.class
                );

        for (
                FootballWinnerParser.Status status :
                FootballWinnerParser.Status.values()
        ) {
            parserStatuses.put(
                    status,
                    0
        ...
        List<Rejected> rejectedWinnerLike =
                new ArrayList<>();
        ...
        for (
            ...
            if (
                ...
                if (
                        parser.looksWinnerLike(
                                candidate.tipTitle()
                        )
                                && result.status()
                                != FootballWinnerParser.Status.NOT_WINNER
                ) {
                    Rejected rejected =
                            new Rejected(
                                    candidate,
         ...
         * =====================================================
         *
         * PURE_WINNER ma być rodziną zamkniętą.
         *
         * Jeżeli parser widzi winner-like rekord, ale nie potrafi
         * jednoznacznie wskazać participant-a, nie robimy częściowego
         * apply. Najpierw audytujemy problem.
         */
        if (
        ...
        /*
         * Każdy parsed rekord musi posiadać gotowy update.
         */
        if (
                parsed.size()
                        != updates.size()
        ...
        /*
         * Nie traktujemy braku fulltime jako błędu całej aplikacji,
         * bo rekord po prostu pozostaje PENDING.
         *
         * W obecnym historycznym audycie oczekujemy jednak 0.
         */
    ...
    private static boolean parseApplyFlag(
        ...
        throw new IllegalArgumentException(
                "Usage: SettleFootballWinnerMain [--apply]"
        );
    }
    ...
    private static SettlementDecision settle(
        ...
        throw new IllegalStateException(
                "Unsupported PURE_WINNER selection="
                        + selection
        );
    }
    ...
    private static boolean isSubjectIssue(
        ...
        return status
                == FootballWinnerParser.Status.SUBJECT_NOT_FOUND
                || status
                == FootballWinnerParser.Status.SUBJECT_MISMATCH
                || status
                == FootballWinnerParser.Status.SUBJECT_AMBIGUOUS;
    }
    ...
    private static void printHeader(
        ...
        System.out.println(
                "Zagranie Typer — Football PURE WINNER Settlement"
        );
    ...
    private static void printParsed(
        ...
        for (
            ...
            FootballWinnerParser.ParseResult p =
                    row.parseResult();
    ...
    private static void printRejectedExamples(
            List<Rejected> rejected
    ) {
        System.out.println();
    ...
    private static void printDryRunFooter() {
        ...
        System.out.println(
                "  pl.zagranietyper.SettleFootballWinnerMain --apply"
        );
    }
    ...
    private record Parsed(
            FootballSettlementRepository.Candidate candidate,
            FootballWinnerParser.ParseResult parseResult,
            SettlementDecision decision
    ) {
    }
