...
import pl.zagranietyper.parser.FootballWinnerTeamTotalParser;
...
public final class SettleFootballWinnerTeamTotalMain {
    ...
    private SettleFootballWinnerTeamTotalMain() {
    }
    ...
    public static void main(
        ...
        FootballWinnerTeamTotalParser parser =
        ...
        Map<FootballWinnerTeamTotalParser.Status, Integer>
                parserStatuses =
                new EnumMap<>(
                        FootballWinnerTeamTotalParser.Status.class
                );

        for (
                FootballWinnerTeamTotalParser.Status status :
                FootballWinnerTeamTotalParser.Status.values()
        ) {
            parserStatuses.put(
                    status,
                    0
        ...
        for (
            ...
            if (
                ...
                if (
                        parser.looksLikeWinnerTeamTotal(
                                candidate.tipTitle()
                        )
                ) {
                    Rejected row =
        ...
        /*
         * Ta rodzina ma mieć zero problemów
         * z identyfikacją zwycięzcy.
         *
         * Jeżeli po audycie pojawi się choć jeden nowy
         * mismatch / ambiguous / not found,
        ...
        /*
         * Historyczny settlement:
         * każdy parsed rekord musi posiadać score.
         */
        if (
                missingFulltime != 0
        ) {
        ...
        /*
         * Jeden parsed = jeden SettlementUpdate.
         */
        if (
                parsed.size()
                        != updates.size()
    ...
    private static boolean parseApplyFlag(
        ...
        throw new IllegalArgumentException(
                "Usage: SettleFootballWinnerTeamTotalMain [--apply]"
        );
    }
    ...
    private static boolean isSubjectIssue(
        ...
        return status
                == FootballWinnerTeamTotalParser.Status.SUBJECT_NOT_FOUND
                || status
                == FootballWinnerTeamTotalParser.Status.SUBJECT_MISMATCH
                || status
                == FootballWinnerTeamTotalParser.Status.SUBJECT_AMBIGUOUS;
    }
    ...
    private static void printHeader(
        ...
        System.out.println(
                "Zagranie Typer — Football WINNER + TEAM TOTAL Settlement"
        );
    ...
    private static void printParsed(
        ...
        for (
            ...
            FootballWinnerTeamTotalParser.ParseResult p =
                    row.parseResult();
    ...
    private static void printRejected(
        ...
        System.out.println(
                "WINNER+TEAM-TOTAL-LIKE REJECTED="
                        + rejected.size()
        );
    ...
    private static void printDryRunFooter() {
        ...
        System.out.println(
                "  pl.zagranietyper.SettleFootballWinnerTeamTotalMain --apply"
        );
    }
    ...
    private record Parsed(
            FootballSettlementRepository.Candidate candidate,
            FootballWinnerTeamTotalParser.ParseResult parseResult,
            SettlementDecision decision
    ) {
    }
