...
import pl.zagranietyper.parser.FootballDoubleChanceParser;
...
public final class SettleFootballDoubleChanceMain {
    ...
    private SettleFootballDoubleChanceMain() {
    }
    ...
    public static void main(
        ...
        FootballDoubleChanceParser parser =
        ...
        Map<FootballDoubleChanceParser.Status, Integer>
                parserStatuses =
                new EnumMap<>(
                        FootballDoubleChanceParser.Status.class
                );

        for (
                FootballDoubleChanceParser.Status status :
                FootballDoubleChanceParser.Status.values()
        ) {
            parserStatuses.put(
                    status,
                    0
    ...
    private static boolean parseApplyFlag(
        ...
        throw new IllegalArgumentException(
                "Usage: SettleFootballDoubleChanceMain [--apply]"
        );
    }
    ...
    private static boolean isSubjectIssue(
        ...
        return status
                == FootballDoubleChanceParser.Status.SUBJECT_NOT_FOUND
                || status
                == FootballDoubleChanceParser.Status.SUBJECT_MISMATCH
                || status
                == FootballDoubleChanceParser.Status.SUBJECT_AMBIGUOUS;
    }
    ...
    private static void printHeader(
        ...
        System.out.println(
                "Zagranie Typer — Football DOUBLE CHANCE Settlement"
        );
    ...
    private static void printParsed(
        ...
        for (
            ...
            FootballDoubleChanceParser.ParseResult p =
                    row.parseResult();
    ...
    private static void printDryRunFooter() {
        ...
        System.out.println(
                "  pl.zagranietyper.SettleFootballDoubleChanceMain --apply"
        );
    }
    ...
    private record Parsed(
            FootballSettlementRepository.Candidate candidate,
            FootballDoubleChanceParser.ParseResult parseResult,
            SettlementDecision decision
    ) {
    }
