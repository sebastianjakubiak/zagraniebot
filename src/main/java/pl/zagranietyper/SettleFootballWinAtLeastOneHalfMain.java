...
import pl.zagranietyper.parser.FootballWinAtLeastOneHalfParser;
...
public final class SettleFootballWinAtLeastOneHalfMain {
    ...
    private SettleFootballWinAtLeastOneHalfMain() {
    }
    ...
    public static void main(
        ...
        FootballWinAtLeastOneHalfParser parser =
        ...
        Map<FootballWinAtLeastOneHalfParser.Status, Integer>
                parserStatuses =
                new EnumMap<>(
                        FootballWinAtLeastOneHalfParser.Status.class
                );

        for (
                FootballWinAtLeastOneHalfParser.Status status :
                FootballWinAtLeastOneHalfParser.Status.values()
        ) {
            parserStatuses.put(
                    status,
                    0
        ...
        for (
            ...
            if (
                ...
                if (
                        parser.looksLikeAtLeastOneHalf(
                                candidate.tipTitle()
                        )
                ) {
                    Rejected row =
        ...
        int unsupportedComposite =
                parserStatuses.get(
                        FootballWinAtLeastOneHalfParser.Status
    ...
    private static boolean parseApplyFlag(
        ...
        throw new IllegalArgumentException(
                "Usage: SettleFootballWinAtLeastOneHalfMain [--apply]"
        );
    }
    ...
    private static boolean isSubjectIssue(
        ...
        return status
                == FootballWinAtLeastOneHalfParser.Status.SUBJECT_NOT_FOUND
                || status
                == FootballWinAtLeastOneHalfParser.Status.SUBJECT_MISMATCH
                || status
                == FootballWinAtLeastOneHalfParser.Status.SUBJECT_AMBIGUOUS;
    }
    ...
    private static void printHeader(
        ...
        System.out.println(
                "Zagranie Typer — Football WIN AT LEAST ONE HALF Settlement"
        );
    ...
    private static void printParsed(
        ...
        for (
            ...
            FootballWinAtLeastOneHalfParser.ParseResult p =
                    row.parseResult();
    ...
    private static void printRejected(
        ...
        System.out.println(
                "AT-LEAST-ONE-HALF-LIKE REJECTED="
                        + rejected.size()
        );
    ...
    private static void printDryRunFooter() {
        ...
        System.out.println(
                "  pl.zagranietyper.SettleFootballWinAtLeastOneHalfMain --apply"
        );
    }
    ...
    private record Parsed(
            Candidate candidate,
            FootballWinAtLeastOneHalfParser.ParseResult parseResult,
            SettlementDecision decision
    ) {
    }
