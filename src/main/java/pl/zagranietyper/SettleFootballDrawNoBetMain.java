...
import pl.zagranietyper.parser.FootballDrawNoBetParser;
...
public final class SettleFootballDrawNoBetMain {
    ...
    private SettleFootballDrawNoBetMain() {
    }
    ...
    public static void main(
        ...
        FootballDrawNoBetParser parser =
        ...
        Map<FootballDrawNoBetParser.Status, Integer>
                parserStatuses =
                new EnumMap<>(
                        FootballDrawNoBetParser.Status.class
                );

        for (
                FootballDrawNoBetParser.Status status :
                FootballDrawNoBetParser.Status.values()
        ) {
            parserStatuses.put(
                    status,
                    0
        ...
        int unsupportedFormat =
                parserStatuses.get(
                        FootballDrawNoBetParser.Status.UNSUPPORTED_FORMAT
                );
        ...
        if (
            ...
            throw new IllegalStateException(
                    "REFUSING APPLY: unsupportedFormat="
                            + unsupportedFormat
            );
        }
    ...
    private static boolean parseApplyFlag(
        ...
        throw new IllegalArgumentException(
                "Usage: SettleFootballDrawNoBetMain [--apply]"
        );
    }
    ...
    private static boolean isSubjectIssue(
        ...
        return status
                == FootballDrawNoBetParser.Status.SUBJECT_NOT_FOUND
                || status
                == FootballDrawNoBetParser.Status.SUBJECT_MISMATCH
                || status
                == FootballDrawNoBetParser.Status.SUBJECT_AMBIGUOUS;
    }
    ...
    private static void printHeader(
        ...
        System.out.println(
                "Zagranie Typer — Football DRAW NO BET Settlement"
        );
    ...
    private static void printParsed(
        ...
        for (
            ...
            FootballDrawNoBetParser.ParseResult p =
                    row.parseResult();
    ...
    private static void printDryRunFooter() {
        ...
        System.out.println(
                "  pl.zagranietyper.SettleFootballDrawNoBetMain --apply"
        );
    }
    ...
    private record Parsed(
            FootballSettlementRepository.Candidate candidate,
            FootballDrawNoBetParser.ParseResult parseResult,
            SettlementDecision decision
    ) {
    }
